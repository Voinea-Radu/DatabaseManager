...
![Version](https://img.shields.io/badge/Version-5.0.21-red.svg)
...
dependencies {
    implementation "dev.lightdream:database-manager:5.0.21"
    implementation "com.github.L1ghtDream:database-manager:5.0.21"
}
```
